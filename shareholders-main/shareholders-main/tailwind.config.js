...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ["var(--font-english)", "var(--font-arabic)", "ui-sans-serif", "system-ui", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "sans-serif"],
        arabic: ["var(--font-arabic)", "ui-sans-serif", "system-ui"],
        english: ["var(--font-english)", "ui-sans-serif", "system-ui"],
      },
    },
  },
  plugins: [],
